    ...
    <div id="page">
        ...
        <aside id="clr-hero">
            <div class="flexslider">
                <ul class="slides">
                    <li
                        style="background-image: url(https://assets.adidas.com/images/h_840,f_auto,q_auto,fl_lossy,c_fill,g_auto/2bcc7b3fc0164b349f5aaed201048fe1_9366/Fluidflow_2.0_Shoes_Blue_GW4012_01_standard.jpg);">
